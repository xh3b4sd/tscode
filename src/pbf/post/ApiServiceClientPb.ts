/**
 * @fileoverview gRPC-Web generated client stub for post
 * @enhanceable
 * @public
 */
...
export class APIClient {
  ...
  create(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/post.API/Create",
        request,
        metadata || {},
  ...
  delete(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/post.API/Delete",
        request,
        metadata || {},
  ...
  search(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/post.API/Search",
        request,
        metadata || {},
  ...
  update(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + "/post.API/Update",
        request,
        metadata || {},
