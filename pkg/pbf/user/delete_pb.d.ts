...
export class DeleteI extends jspb.Message {
  ...
  static serializeBinaryToWriter(message: DeleteI, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DeleteI;
  static deserializeBinaryFromReader(message: DeleteI, reader: jspb.BinaryReader): DeleteI;
}
...
export class DeleteO extends jspb.Message {
  ...
  static serializeBinaryToWriter(message: DeleteO, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DeleteO;
  static deserializeBinaryFromReader(message: DeleteO, reader: jspb.BinaryReader): DeleteO;
}
